...
assert 5 'main() { int a; a=1; return a+4; }'
assert 6 'main() { int a=2; return a+4; }'
assert 0 'main() { int a=2==3; return a; }'
assert 8 'main() { int r=1+2*3; return 1+r; }'
assert 14 'main() { int foo=1+2*3; return foo*2; }'
assert 15 'main() { int foo=1+2*3; int bar=foo+1; return foo+bar; }'
assert 15 'main() { int foo=1+2*3; int faa=foo+1; return foo+faa; }'
assert 3 'main() { int foo=1+2; return foo; }'
assert 3 'main() { int foo=1+2; return foo; return foo+2; }'
...
assert 6 'main() { for (int i=0; i<5; i=i+3) 10; return i; }'
assert 10 'main() { for (;;) return 10; }'
assert 6 'main() { int i=0; while (i<5) i=i+3; return i; }'

assert 10 'main() { return 10; }'
assert 10 'main() { int x=10; return x; }'
assert 10 'main() { if (1) { int x=10; return x; } else { int y=11; return y; } }'
assert 11 'main() { if (0) { int x=10; return x; } else { int y=11; return y; } }'
assert 12 'main() { if (0) { int x=10; return x; } else {} return 12; }'
...
assert 5 'main() { int x=3; int y=5; int z=&x+1; return *z; }'
